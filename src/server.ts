...
export default class Server{
    ...
    middlewares():void{
        ...
        this.app.use((req, res, next) => {
            res.header('Access-Control-Allow-Origin', 'http://localhost:3000'||"https://kanto-pokedex-client.vercel.app/"); // update to match the domain you will make the request from
